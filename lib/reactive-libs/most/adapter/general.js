...
module.exports = function createGeneralOperators(cepjsMost) {
  ...
  * @return {Stream} a new stream instance.
  */
  operators.skipUntil = outerEventStream => operations.since(flatStream(outerEventStream));
  ...
  * @return {Stream} a new stream instance.
  */
  operators.takeUntil = outerEventStream => operations.until(flatStream(outerEventStream));
  ...
  * @return {Stream} a new stream instance.
  */
  operators.mergeMap = operators.flatMap = projectionFn => operations.chain(_.compose(flatStream, projectionFn));
