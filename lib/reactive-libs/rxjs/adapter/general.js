...
const flatStream = eventStream => eventStream instanceof EventStream ? eventStream._stream : eventStream;
...
module.exports = function createGeneralOperators(cepjsRx) {
   ...
   * @return {Observable} a new stream instance.
   */
  operators.skipUntil = outerEventStream => operations.skipUntil(flatStream(outerEventStream));
   ...
   * @return {Observable} a new stream instance.
   */
  operators.takeUntil = outerEventStream => operations.takeUntil(flatStream(outerEventStream));
   ...
   * @return {Observable} a new stream instance.
   */
  operators.mergeMap = operators.flatMap = projectionFn => operations.mergeMap(_.compose(flatStream, projectionFn));
   ...
   * @return {Observable} a new stream instance.
   */
  operators.concatMap = projectionFn => operations.concatMap(_.compose(flatStream, projectionFn));
