 ...
 */
const minDistance = (eventTypeList, givenPoint, attribute, assertion, newEvtTypeId) => stream => {
 ...
 * @return {EventStream} a new event stream instance.
 */
const maxDistance = (eventTypeList, givenPoint, attribute, assertion, newEvtTypeId) => stream => {
    const preds = predEvtTypeList(eventTypeList);
    const attributeLens = getLens(attribute);
    const calcDistance = curriedDistanceFn(givenPoint, attributeLens);
 ...
 * @return {EventStream} a new event stream instance.
 */
const avgDistance = (eventTypeList, givenPoint, attribute, assertion, newEvtTypeId) => stream => {
    const preds = predEvtTypeList(eventTypeList);
    const attributeLens = getLens(attribute);
    const calcDistance = curriedDistanceFn(givenPoint, attributeLens);
 ...
 * @return {EventStream} a new event stream instance.
 */
const relativeMinDistance = (eventTypeList, attribute, assertion, newEvtTypeId) => stream => {
    const preds = predEvtTypeList(eventTypeList);
    const attributeLens = getLens(attribute);
 ...
 * @return {EventStream} a new event stream instance.
 */
const relativeMaxDistance = (eventTypeList, attribute, assertion, newEvtTypeId) => stream => {
    const preds = predEvtTypeList(eventTypeList);
    const attributeLens = getLens(attribute);
    const calcDistance = distanceFn(attributeLens);
 ...
 * @return {EventStream} a new event stream instance.
 */
const relativeAvgDistance = (eventTypeList, attribute, assertion, newEvtTypeId) => stream => {
    const preds = predEvtTypeList(eventTypeList);
    const attributeLens = getLens(attribute);
    const calcDistance = distanceFn(attributeLens);
