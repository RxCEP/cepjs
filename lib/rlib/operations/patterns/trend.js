...
const { isWindow, filterEvtsByEvtTypes, getProp, deriveEvt, AccHelper } = require('../../helperFunctions')
 ...
 */
const increasing = (eventTypeList, attribute, orderPolicy, newEvtTypeId) => stream => {
 ...
 * @return {EventStream} a new event stream instance.
 */
const decreasing = (eventTypeList, attribute, orderPolicy, newEvtTypeId) => stream => {
    const preds = predEvtTypeList(eventTypeList); //a list of predicates with the event type list
    const attributeProp = getProp(attribute);
    const orderProp = getPropOrderPolicy(orderPolicy);
 ...
 * @return {EventStream} a new event stream instance.
 */
const stable = (eventTypeList, attribute, orderPolicy, newEvtTypeId) => stream => {
    const preds = predEvtTypeList(eventTypeList); //a list of predicates with the event type list
    const attributeProp = getProp(attribute);
    const orderProp = getPropOrderPolicy(orderPolicy);
 ...
 * @return {EventStream} a new event stream instance.
 */
const nonIncreasing = (eventTypeList, attribute, orderPolicy, newEvtTypeId) => stream => {
    const preds = predEvtTypeList(eventTypeList); //a list of predicates with the event type list
    const attributeProp = getProp(attribute);
    const orderProp = getPropOrderPolicy(orderPolicy);
 ...
 * @return {EventStream} a new event stream instance.
 */
const nonDecreasing = (eventTypeList, attribute, orderPolicy, newEvtTypeId) => stream => {
    const preds = predEvtTypeList(eventTypeList); //a list of predicates with the event type list
    const attributeProp = getProp(attribute);
    const orderProp = getPropOrderPolicy(orderPolicy);
 ...
 * @return {EventStream} a new event stream instance.
 */
const mixed = (eventTypeList, attribute, orderPolicy, newEvtTypeId) => stream => {
    const preds = predEvtTypeList(eventTypeList); //a list of predicates with the event type list
    const attributeProp = getProp(attribute);
    const orderProp = getPropOrderPolicy(orderPolicy);
