 ...
 */
const count = (eventTypeList, assertion, newEvtTypeId) => stream => {
 ...
 * @return {EventStream} a new event stream instance.
 */
const valueMax = (eventTypeList, attribute, assertion, newEvtTypeId) => stream => {
 ...
 * @return {EventStream} a new event stream instance.
 */
const valueMin = (eventTypeList, attribute, assertion, newEvtTypeId) => stream => {
 ...
 * @return {EventStream} a new event stream instance.
 */
const valueAvg = (eventTypeList, attribute, assertion, newEvtTypeId) => stream => {
