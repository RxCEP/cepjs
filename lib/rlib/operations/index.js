...
const flatStream = eventStream => R.is(EventStream, eventStream) ? eventStream.stream : eventStream;
 ...
 * @return {EventStream} a new event stream instance.
 */
const debounceTime = timeDuration => rDebounceTime(timeDuration);
 ...
 * @return {EventStream} a new event stream instance.
 */
const throttleTime = timeDuration => rThrottleTime(timeDuration);
 ...
 * @return {EventStream} a new event stream instance.
 */
const switchMap = projectionFn => rSwitchMap(R.compose(flatStream, projectionFn));
