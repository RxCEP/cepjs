const {merge: rMerge} = require('../lib').factoryOperators;
const {filter: rFilter, tap: rTap, map: rMap, mergeMap: rMergeMap, concatMap: rConcatMap,
switchMap: rSwitchMap} = require('../lib').operators;
...
const {tumblingCountWindow: customTumblingCountWindow, slidingCountWindow: customSlidingCountWindow,
    ...
    relativeAvgDistance: customRelativeAvgDistance, project: customProject} = require('../lib');
...
function tap(fn){
    return function(stream){
        return esConstructor(stream._observable.pipe(rTap(fn)));
    }
}
...
function filter(fn){
    return function(stream){
        return esConstructor(stream._observable.pipe(rFilter(fn)));
    }
}
...
function merge(...streams){
    return function(stream){
        return streams.length > 0
            ? esConstructor(R.compose(R.apply(rMerge), R.prepend(stream._observable), R.pluck('_observable'))(streams))
            : stream;
    }
}
...
function project(list, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customProject(list, newEvtTypeId)));
    }
}
...
function map(projectionFn){
    return function(stream){
        return esConstructor(stream._observable.pipe(rMap(projectionFn)));
    }
}
/**
 * 
...
function mergeMap(projectionFn){
    return function(stream){
        return esConstructor(stream._observable.pipe(rMergeMap(projectionFn)));
    }
}
/**
 * 
...
function concatMap(projectionFn){
    return function(stream){
        return esConstructor(stream._observable.pipe(rConcatMap(projectionFn)));
    }
}
/**
 * 
...
function switchMap(projectionFn){
    return function(stream){
        return esConstructor(stream._observable.pipe(rSwitchMap(projectionFn)));
    }
}
...
function tumblingCountWindow(n){
    return function(stream){
        return esConstructor(stream._observable.pipe(customTumblingCountWindow(n)));
    }
}
/**
 * 
...
function slidingCountWindow(n){
    return function(stream){
        return esConstructor(stream._observable.pipe(customSlidingCountWindow(n)));
    }
}
/**
 * 
...
function hoppingCountWindow(n, hopSize){
    return function(stream){
        return esConstructor(stream._observable.pipe(customHoppingCountWindow(n, hopSize)));
    }
}
/**
 * 
...
function tumblingTemporalWindow(mSeconds){
    return function(stream){
        return esConstructor(stream._observable.pipe(customTumblingTemporalWindow(mSeconds)));
    }
}
/**
 * 
...
function hoppingTemporalWindow(mSeconds, hopSize){
    return function(stream){
        return esConstructor(stream._observable.pipe(customHoppingTemporalWindow(mSeconds, hopSize)));
    }
}
/**
 * 
...
function fixedIntervalWindow(start, end, recurrence, order){
    return function(stream){
        return esConstructor(stream._observable.pipe(customFixedIntervalWindow(start, end, recurrence, order)));
    }
}
/**
 * 
...
function eventIntervalWindow(initiatorEvents, terminatorEvents, expirationTime){
    return function(stream){
        return esConstructor(stream._observable
...
function all(eventTypeList, newEvtTypeId, assertion){
    return function(stream){
        return esConstructor(stream._observable.pipe(customAll(eventTypeList, newEvtTypeId, assertion)));
    }
}
/**
...
function any(eventTypeList, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customAny(eventTypeList, newEvtTypeId)));
    }
}
/**
...
function abscence(eventTypeList, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customAbscence(eventTypeList, newEvtTypeId)));
    }
}
...
function always(eventTypeList, assertion, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customAlways(eventTypeList, assertion, newEvtTypeId)));
    }
}
/**
...
function sometimes(eventTypeList, assertion, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customSometimes(eventTypeList, assertion, newEvtTypeId)));
    }
}
...
function nHighestValues(eventTypeList, n, attribute, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customNhighestValues(eventTypeList, n, attribute, newEvtTypeId)));
    }
}
/**
...
function nLowestValues(eventTypeList, n, attribute, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customNlowestValues(eventTypeList, n, attribute, newEvtTypeId)));
    }
}
...
function count(eventTypeList, assertion, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customCount(eventTypeList, assertion, newEvtTypeId)));
    }
}
/**
...
function valueMax(eventTypeList, attribute, assertion, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customValueMax(eventTypeList, attribute, assertion, newEvtTypeId)));
    }
}
/**
...
function valueMin(eventTypeList, attribute, assertion, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customValueMin(eventTypeList, attribute, assertion, newEvtTypeId)));
    }
}
/**
...
function valueAvg(eventTypeList, attribute, assertion, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customValueAvg(eventTypeList, attribute, assertion, newEvtTypeId)));
    }
}
...
function increasing(eventTypeList, attribute, orderPolicy, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customIncreasing(eventTypeList, attribute, orderPolicy, newEvtTypeId)));
    }
}
/**
 * 
...
function decreasing(eventTypeList, attribute, orderPolicy, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customDecreasing(eventTypeList, attribute, orderPolicy, newEvtTypeId)));
    }
}
/**
 * 
...
function stable(eventTypeList, attribute, orderPolicy, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customStable(eventTypeList, attribute, orderPolicy, newEvtTypeId)));
    }
}
/**
 * 
...
function nonIncreasing(eventTypeList, attribute, orderPolicy, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customNonIncreasing(eventTypeList, attribute, orderPolicy, newEvtTypeId)));
    }
}
/**
 * 
...
function nonDecreasing(eventTypeList, attribute, orderPolicy, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customNonDecreasing(eventTypeList, attribute, orderPolicy, newEvtTypeId)));
    }
}
/**
 * 
...
function mixed(eventTypeList, attribute, orderPolicy, newEvtTypeId){
    return function(stream){
        return esConstructor(stream._observable.pipe(customMixed(eventTypeList, attribute, orderPolicy, newEvtTypeId)));
    }
}
